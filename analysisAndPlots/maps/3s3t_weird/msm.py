...
dataPoints = makeLatLons('oneDeg')
lats = dataPoints[0]
lons = dataPoints[1]

data2 = makeLatLons('twoDeg')
lats2 = data2[0]
lons2 = data2[1]
data3 = makeLatLons('fiveDeg')
lats3 = data3[0]
lons3 = data3[1]
...
plt.ylabel('latitude')
plt.title('different noise for three stars observed at a different times')
plt.legend()
