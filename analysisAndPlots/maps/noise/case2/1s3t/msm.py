...
dataPoints = makeLatLons('case1_1s3t_1')
lats = dataPoints[0]
lons = dataPoints[1]

data2 = makeLatLons('case1_1s3t_2')
lats2 = data2[0]
lons2 = data2[1]
data3 = makeLatLons('case1_1s3t_5')
lats3 = data3[0]
lons3 = data3[1]
...
plt.ylabel('latitude')
plt.title('different noise for one star observed three times')
plt.legend()
